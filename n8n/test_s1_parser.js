...
const $input = { item: { json: { textContent: text, subject: 'Neuer Suchauftrag wurde angelegt', from: 'ImmoScout24 <myscout@immobilienscout24.de>', to: 'immo+is24@rosenkranz.cologne', uid: 1 } } };
